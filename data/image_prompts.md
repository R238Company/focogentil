...
Imagens usadas no Simulado 01 (20 questões de Geografia). Gere cada uma no Grok Imagine, baixe o resultado e salve com o **nome de arquivo exato** indicado dentro de `site/assets/images/` (formato `.jpg` — é o padrão configurado em `site/js/app.js`; se usar `.png`, ajuste a extensão lá).
